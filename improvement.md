...
| #5 | Modular backend structure | 🚧 In progress | Modules router now mounted at `/api`; `auth` has module-local routes; service-layer migration still pending for other domains |
